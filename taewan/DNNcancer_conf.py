...
####Read data####
xdata = np.genfromtxt ('/Users/taewan/Downloads/DNNDatasets/DNNToyVar1.csv', delimiter=",",usecols=np.arange(0,2007))
ydata = np.genfromtxt ('/Users/taewan/Downloads/DNNDatasets/CancerResult.csv', delimiter=",")
