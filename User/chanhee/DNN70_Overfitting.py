...
def set_train_three_layer(num,repeat, nodes, learning_rate):
    ...
    l2reg = 0.01 * tf.reduce_sum(tf.square(W1))
...
def set_train_four_layer(num ,repeat, nodes, learning_rate):
    ...
    l2reg = 0.01 * tf.reduce_sum(tf.square(W4))
...
conf_filename = '/home/tjahn/Git/Data/input/overfitting70.csv'
...
conf.to_csv('/home/tjahn/Git/Data/output/overfitting70_result.csv')
