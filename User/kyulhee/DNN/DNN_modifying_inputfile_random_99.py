...
def set_train_three_layer(nodes, learning_rate, j, gene_off):
    ...
    with tf.Session() as sess:
        ...
        writer = tf.summary.FileWriter("/home/tjahn/tf_save_data/kyulhee/tensorboard/random_gene_off_"+str(int(gene_off)) +"/" + str(nodes) +"_" + str(j+1))
...
####sm
    datafilename = "/home/tjahn/Data/FinalData_Random_"+str(int(gene_off))+"off_GSM_gene_index_result.csv"
