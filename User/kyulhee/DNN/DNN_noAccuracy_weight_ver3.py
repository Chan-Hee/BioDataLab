...
#save path
        ...
        abs_sum_matrix = pd.DataFrame(data={"names": gene_names, "abs_w_sum": weighted_abs_sum, "index": j})
    ...
    return train_p ,train_h, test_p,test_h,weighted_sum_result,abs_sum_matrix
...
####sm
  ...
  #  Max_Accuracy = []
    ...
    ####Cal Data Set#####
        ...
        train_p, train_h , test_p ,test_h, weighted_sum_result, abs_sum_matrix = (set_train_three_layer(nodes, learning_rate, j, gene_off))
...
abs_sum_matrix.to_csv(output_directory+"abs",sep=",")
