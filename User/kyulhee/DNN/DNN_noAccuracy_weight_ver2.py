...
#save path
    ...
    return train_p ,train_h, test_p,test_h,weighted_sum_result,weighted_abs_sum
...
####sm
  ...
  #  Max_Accuracy = []
    ...
    ####Cal Data Set#####
        ...
        train_p, train_h , test_p ,test_h, weighted_sum_result, weighted_abs_sum = (set_train_three_layer(nodes, learning_rate, j, gene_off))
      ...
      #  Max_Accuracy.append(weighted_sum_result[5])
        print("weighted_abs_sum= ",weighted_abs_sum)
## Accuracy Data 생성 ##
...
#W1_list.to_csv(output_directory+"W1_list",sep=",")
