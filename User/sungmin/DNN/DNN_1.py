...
def set_train_three_layer(nodes, learning_rate, j, gene_off):
    ...
    with tf.Session() as sess:
        ...
        writer = tf.summary.FileWriter(tensorboard_directory+"with_rare_cancer/gene_off_"+str(int(gene_off)) +"/" + str(nodes) +"_" + str(j+1))
...
####message for stsrt
    ...
    with tf.Session() as sess:
        merged_summary = tf.summary.merge_all()
        writer = tf.summary.FileWriter(tensorboard_directory+"with_rare_cancer/gene_off_"+str(int(gene_off)) +"/" + str(layer) +"/" + str(nodes) +"_" + str(five_fold_count+1))
        writer.add_graph(sess.graph)
...
tensorboard_directory = "/home/tjahn/tf_save_data/sungmin/tensorboard/"
save_path_directory = "/home/tjahn/tf_save_data/sungmin/save_path/with_rare_cancer/saved/"
