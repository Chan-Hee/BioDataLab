...
def set_train_three_layer(num,repeat, nodes, learning_rate,j):
    ...
    with tf.Session() as sess:
        ...
        writer = tf.summary.FileWriter("./log_top5/96/" + node+"_"+js)
...
conf_sungmin = '/home/tjahn/Git/User/sungmin/fftb/input/top5_1.csv'
...
conf.to_csv('/home/tjahn/Git/User/sungmin/fftb/output/ff_top5_96_1.csv' , sep= ',')
